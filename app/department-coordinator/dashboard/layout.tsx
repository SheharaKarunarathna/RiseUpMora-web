...
export default function DepartmentCoordinatorLayout({ children }: { children: React.ReactNode }) {
    ...
    <div className="flex min-h-screen bg-[#f8fcfe]">
      ...
      <div className="flex-1 flex flex-col w-full">
        <header className="flex h-16 items-center justify-between border-b border-[#002454]/10 bg-white/50 px-8 backdrop-blur-md">
          <Link href="/department-coordinator/dashboard" className="flex items-center gap-2 text-xl font-extrabold text-[#002454]">
            <BookOpen className="text-[#33aeda]" size={24} />
            <span>Rise Up <span className="text-[#33aeda]">Dept.</span></span>
          </Link>
